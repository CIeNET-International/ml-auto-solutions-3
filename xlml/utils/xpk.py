...
def run_workload(
  ...
  with tempfile.TemporaryDirectory() as tmpdir:
    ...
    # I this flag is added when using other branches it will break
    ...
    if mtc_enabled:
      # b/437817546 - The supported flag was "mtc-enabled" (with hyphen),
      # for version > 0.4.1, it has changed to "mtc_enabled" (with underscore).
      flag = (
