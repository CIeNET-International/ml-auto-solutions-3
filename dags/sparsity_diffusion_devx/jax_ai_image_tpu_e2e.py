...
with models.DAG(
    dag_id="jax_ai_image_tpu_e2e_gateway_0420",
        ...
        with dag:
            ...
            for slice_num in slices:
                for mode, image in maxtext_docker_images:
                    ...
                    is_gateway_needed = (accelerator == "v6e-256")
                    k8s_task = maxtext_task_wrapper.run_with_quarantine(
                    quarantine_task_group,
                    use_gateway=is_gateway_needed
                    )
        ...
        with dag:
            ...
            for slice_num in slices:
                for mode, image in maxdiffusion_docker_images:
                    ...
                    is_gateway_needed = (accelerator == "v6e-256")
                    k8s_task = maxdiffusion_task_wrapper.run_with_quarantine(
                        quarantine_task_group,
                        use_gateway=is_gateway_needed
                    )
