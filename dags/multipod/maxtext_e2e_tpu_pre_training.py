...
from dags.maxtext_pathways.configs.goodput_utils import report_workload_goodput
  ...
  for model, test_config in test_models.items():
    with TaskGroup(group_id=model) as model_group:
      ...
      training_cmd = (
          ...
          f"export GOODPUT_JOB_NAME={goodput_job_name}",
          cleanup_cmd,
      ...
      report_goodput_task = report_workload_goodput(
