...
with models.DAG(
  ...
  for mode, image in docker_images:
    ...
    # Checkpoint resharding test -
    # trains a model with a specific sharding strategy and saves a checkpoint.
    ...
    gke_config.get_gke_config(
        ...
        run_model_cmds=(
            f"bash tests/end_to_end/tpu/test_checkpoint_resharding.sh "
            f"checkpoint-resharding-{mode.value} "
