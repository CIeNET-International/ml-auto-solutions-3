...
with models.DAG(
    dag_id="maxtext_mtc_orbax_res02_restore_local",
  ...
  base_output_directory = f"{gcs_bucket.MTC_AUTOMATION_BUCKET}/maxtext_mtc_orbax_res02_restore_local"
  docker_images = [(
      SetupMode.NIGHTLY,
  ...
  use_replicator_flags = "True"
  model_name = "llama2-7b"
  name_prefix = "max-res02-loc"
  tests_to_run_seq = []
