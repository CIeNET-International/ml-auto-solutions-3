...
with models.DAG(
  ...
  checkpointing = test_config_util.Checkpointing(
      name="reg", enable_multi_tier_checkpointing=False, enable_emergency_checkpoint=False
  )
  test_configs = [
  ...
  for mode, image in DOCKER_IMAGES:
    for test_config in test_configs:
      for slice_num in test_config.slices:
        ...
        steps_to_validate = test_config.generate_step_to_validate(is_local=False)
