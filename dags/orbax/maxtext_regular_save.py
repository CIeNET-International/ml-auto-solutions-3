...
from dags.orbax.util.orbax import TestConfig, CheckpointingMode, DEFAULT_BUCKET
...
with models.DAG(
    ...
    test_configs = [
        TestConfig(
            ...
            step=100,
            gcs_checkpoint_period=25,
            base_dir=DEFAULT_BUCKET,
            mode=CheckpointingMode.REG,  # Use REG mode for this DAG
        ),
    ]
    ...
    for mode, image in DOCKER_IMAGES:
        for test_config in test_configs:
            for slice_num in test_config.slices:
                ...
                # Use the new method to generate steps to validate
                gcs_steps_to_validate = test_config.generate_steps_to_validate(test_config.gcs_checkpoint_period)
