...
REGISTERED_DAGS: dict[str, DagIdToTimeout] = {
    TPU_OBS_MOCK_CLUSTER.name: {
        ...
        "tpu_info_format_validation_dags_exist": dt.timedelta(minutes=45),
        "tpu_sdk_monitoring_validation_exist": DefaultTimeout,
        "tpu_sdk_monitoring_data_validation_exist": DefaultTimeout,
        ...
        "tpu_info_metrics_verification_exist": dt.timedelta(minutes=45),
        "gke_cluster_version_manager": DefaultTimeout,
        "jobset_ttr_pod_delete_exist": dt.timedelta(minutes=90),
        "jobset_ttr_pod_delete_one_file": dt.timedelta(minutes=100),
    },
