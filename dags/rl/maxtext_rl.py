...
from dags.rl.util import validation_util, test_config_util
...
with models.DAG(
  ...
  training_config = test_config_util.RLTestConfig(
      ...
      load_parameters_path=f"gs://{test_config_util.DEFAULT_BUCKET}/llama3.1_70b_instruct/2025-10-15/pathways/scanned/0/items/",
  ...
  for mode, image in test_config_util.DOCKER_IMAGES_RL:
    for slice_num in training_config.slices:
      ...
      rl_training_command = [
          ...
          f"hf_access_token={HF_TOKEN_LLAMA3_1}",
          f"base_output_directory=gs://{training_config.base_dir}",
      ]
