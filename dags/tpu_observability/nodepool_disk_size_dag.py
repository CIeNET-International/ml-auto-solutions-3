...
# temporary fix before ultimate polish
CLUSTER_NAME = "athielee-auto-test"
...
with models.DAG(
    ...
    catchup=False,
    tags=[
        "cienet-cmcs", # cloud-ml-auto-solutions
  ...
  node_pool_info = node_pool.Info(
      ...
      cluster_name=Variable.get(
          "CLUSTER_NAME", default_var="athielee-auto-test"
      ),
  ...
  poll_nodepool = wait_for_nodepool(UPTIME_FILTER_QRY, time_interval)    
  ...
  (
    create_cluster >> create_nodepool >> [disk_size_change, wait_time]
    wait_time >> check_for_negative 
    [disk_size_change, check_for_negative] >> time_interval >> poll_nodepool >> delete_nodepool
  )