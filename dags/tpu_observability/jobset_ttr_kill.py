...
"""A DAG to test jobset time-to-recover metric by SSH into worker Pod and kill the main process."""
...
with models.DAG(  # pylint: disable=unexpected-keyword-arg
    ...
    description=(
        "This DAG tests the use of SSH into a worker Pod to kill the main process, "
    ),
    doc_md="""
      # JobSet Time-To-Recover (TTR) Test by Killing Main Process via SSH
  ...
  for machine in MachineConfigMap:
    ...
    with TaskGroup(  # pylint: disable=unexpected-keyword-arg
      ...
      kill_tasks = jobset.kill_tpu_pod_workload.expand(pod_name=pod_names)
