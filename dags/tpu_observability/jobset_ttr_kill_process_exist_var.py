...
from dags.tpu_observability.utils.jobset_util import JobSet, Workload, get_running_pods
...
DAG_ID = "jobset_ttr_kill_process_exist"
DAGRUN_TIMEOUT = get_dag_timeout(DAG_ID)
SCHEDULE = SchedulingHelper.arrange_schedule_time(DAG_ID)


@task
def kill_tpu_pod_workload(info: node_pool.Info) -> None:
  """
...
with models.DAG(  # pylint: disable=unexpected-keyword-arg
    dag_id=DAG_ID,
    start_date=datetime.datetime(2026, 4, 8),
  ...
  for machine in MachineConfigMap:
    ...
    with TaskGroup(  # pylint: disable=unexpected-keyword-arg
      ...
      wait_for_metric_upload = jobset.wait_for_jobset_ttr_to_be_found.override(
          task_id="wait_for_metric_upload", trigger_rule=TriggerRule.ALL_DONE
      )(
          node_pool=cluster_info,
          jobset_name=jobset_name,
          start_time=kill_tasks,
